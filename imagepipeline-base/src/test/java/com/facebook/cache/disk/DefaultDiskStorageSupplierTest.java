...
public class DefaultDiskStorageSupplierTest {
    ...
    private DefaultDiskStorageSupplier createSupplier(boolean useFilesDirInsteadOfCacheDir) {
        return new DefaultDiskStorageSupplier(mVersion, useFilesDirInsteadOfCacheDir ? Suppliers.of(mContext.getFilesDir()) : Suppliers.of(mContext
                .getCacheDir()), mBaseDirectoryName, mCacheErrorLogger);
    }
