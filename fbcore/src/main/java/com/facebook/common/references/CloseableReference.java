...
public final class CloseableReference<T> implements Cloneable, Closeable {
    ...
    @GuardedBy("this") private boolean mIsClosed = false;
    ...
    protected void finalize() throws Throwable {
        try {
            ...
            FLog.w(TAG, "Finalized without closing: %x %x (type = %s)", System.identityHashCode(this), System.identityHashCode(mSharedReference),
