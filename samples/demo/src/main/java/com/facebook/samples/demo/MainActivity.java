...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImagePipelineConfig config = ImagePipelineConfig.newBuilder(this).setRequestListeners(listeners).setBitmapsConfig(Bitmap.Config.ARGB_8888)
                .build();
        ...
        DraweeController animatedGifController = Fresco.newDraweeControllerBuilder().setAutoPlayAnimations(true).setUri(Uri.parse("https://s3" + "" +
                ".amazonaws.com/giphygifs/media/4aBQ9oNjgEQ2k/giphy.gif")).build();
        mAnimatedGifView.setController(animatedGifController);
        DraweeController animatedWebpController = Fresco.newDraweeControllerBuilder().setAutoPlayAnimations(true).setUri(Uri.parse("https://www" +
                ".gstatic.com/webp/animated/1.webp")).build();
        mAnimatedWebpView.setController(animatedWebpController);
        DraweeController oneLoopWebpController = Fresco.newDraweeControllerBuilder().setAutoPlayAnimations(true).setUri(Uri.parse("https://dl" + "" +
                ".dropboxusercontent.com/u/6610969/webp_180_example.webp")).build();
