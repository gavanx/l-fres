...
public class TransformGestureDetector implements MultiPointerGestureDetector.Listener {
    ...
    public float getTranslationX() {
        return calcAverage(mDetector.getCurrentX(), mDetector.getCount()) - calcAverage(mDetector.getStartX(), mDetector.getCount());
    }

    /** Gets the Y component of the translation */
    public float getTranslationY() {
        return calcAverage(mDetector.getCurrentY(), mDetector.getCount()) - calcAverage(mDetector.getStartY(), mDetector.getCount());
    }
