...
public class MainActivity extends Activity {
    private static final Uri URI = Uri.parse("http://apod.nasa.gov/apod/image/1410/20141008tleBaldridge001h990.jpg");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RoundingParams bitmapOnly = RoundingParams.fromCornersRadius(RADIUS).setRoundingMethod(RoundingParams.RoundingMethod.BITMAP_ONLY);
        RoundingParams overlayColor = RoundingParams.fromCornersRadius(RADIUS).setRoundingMethod(RoundingParams.RoundingMethod.OVERLAY_COLOR)
