    ...
    private void inflateHierarchy(Context context, @Nullable AttributeSet attrs) {
            ...
            try {
                ...
                for (int i = 0; i < indexCount; i++) {
                    ...
                    if (idx == R.styleable.GenericDraweeView_actualImageScaleType) {
                        ...
                        actualImageScaleType = getScaleTypeFromXml(gdhAttrs, R.styleable.GenericDraweeView_actualImageScaleType,
                        ...
                        placeholderScaleType = getScaleTypeFromXml(gdhAttrs, R.styleable.GenericDraweeView_placeholderImageScaleType,
                        ...
                        failureImageScaleType = getScaleTypeFromXml(gdhAttrs, R.styleable.GenericDraweeView_failureImageScaleType,
                                failureImageScaleType);
                    } else if (idx == R.styleable.GenericDraweeView_progressBarImageScaleType) {
                        // progress bar image scale type
                        progressBarScaleType = getScaleTypeFromXml(gdhAttrs, R.styleable.GenericDraweeView_progressBarImageScaleType,
        ...
        if (roundAsCircle || roundedCornerRadius > 0) {
            ...
            if (roundedCornerRadius > 0) {
                roundingParams.setCornersRadii(roundTopLeft ? roundedCornerRadius : 0, roundTopRight ? roundedCornerRadius : 0, roundBottomRight ?
                        roundedCornerRadius : 0, roundBottomLeft ? roundedCornerRadius : 0);
            }
