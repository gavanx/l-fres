...
public class DraweeHolder<DH extends DraweeHierarchy> implements VisibilityCallback {
    ...
    public void onDraw() {
        ...
        FLog.wtf(DraweeEventTracker.class, "%x: Draw requested for a non-attached controller %x. %s", System.identityHashCode(this), System
                .identityHashCode(mController), toString());
        mIsHolderAttached = true;
        mIsVisible = true;
