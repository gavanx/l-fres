...
public class ScaleTypeDrawable extends ForwardingDrawable {
    ...
    void configureBounds() {
        ...
        ScalingUtils.getTransform(mTempMatrix, bounds, underlyingWidth, underlyingHeight, (mFocusPoint != null) ? mFocusPoint.x : 0.5f,
                (mFocusPoint != null) ? mFocusPoint.y : 0.5f, mScaleType);
