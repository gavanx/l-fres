...
public class AbstractDraweeControllerTest {
    ...
    public void setUp() {
        ...
        mController = new FakeDraweeController(mDeferredReleaser, mUiThreadExecutor, mDataSourceSupplier, "id", mCallerContext);
    ...
    private void testListenerReentrancy(int outcome) {
        ...
        ControllerListener listener = new BaseControllerListener<FakeImageInfo>() {
            ...
            @Override
            public void onFinalImageSet(String id, @Nullable FakeImageInfo imageInfo, @Nullable Animatable animatable) {
    ...
    private void initializeAndAttachController(String id, DataSource<FakeImage> dataSource) {
        try {
            ...
            System.err.println("Exception thrown in listener: " + Throwables.getStackTraceAsString(throwable));
        }
    }
    ...
    public void testLoadingS_LS() {
        testStreamedLoading(new int[]{INTERMEDIATE_LOW, SUCCESS}, new int[]{SET_IMAGE_P20, SET_IMAGE_P100});
    }

    @Test
    public void testLoadingS_GS() {
        testStreamedLoading(new int[]{INTERMEDIATE_GOOD, SUCCESS}, new int[]{SET_IMAGE_P50, SET_IMAGE_P100});
    }

    @Test
    public void testLoadingS_FS() {
        testStreamedLoading(new int[]{INTERMEDIATE_FAILURE, SUCCESS}, new int[]{IGNORE, SET_IMAGE_P100});
    }

    @Test
    public void testLoadingS_LF() {
        testStreamedLoading(new int[]{INTERMEDIATE_LOW, FAILURE}, new int[]{SET_IMAGE_P20, SET_FAILURE});
    }

    @Test
    public void testLoadingS_GF() {
        testStreamedLoading(new int[]{INTERMEDIATE_GOOD, FAILURE}, new int[]{SET_IMAGE_P50, SET_FAILURE});
    }
    ...
    public void testLoadingS_LLS() {
        testStreamedLoading(new int[]{INTERMEDIATE_LOW, INTERMEDIATE_LOW, SUCCESS}, new int[]{SET_IMAGE_P20, SET_IMAGE_P20, SET_IMAGE_P100});
    }

    @Test
    public void testLoadingS_FLS() {
        testStreamedLoading(new int[]{INTERMEDIATE_FAILURE, INTERMEDIATE_LOW, SUCCESS}, new int[]{IGNORE, SET_IMAGE_P20, SET_IMAGE_P100});
    }

    @Test
    public void testLoadingS_LGS() {
        testStreamedLoading(new int[]{INTERMEDIATE_LOW, INTERMEDIATE_GOOD, SUCCESS}, new int[]{SET_IMAGE_P20, SET_IMAGE_P50, SET_IMAGE_P100});
    }

    @Test
    public void testLoadingS_GGS() {
        testStreamedLoading(0, new int[]{INTERMEDIATE_GOOD, INTERMEDIATE_GOOD, SUCCESS}, new int[]{SET_IMAGE_P50, SET_IMAGE_P50, SET_IMAGE_P100});
    }

    @Test
    public void testLoadingS_FGS() {
        testStreamedLoading(new int[]{INTERMEDIATE_FAILURE, INTERMEDIATE_GOOD, SUCCESS}, new int[]{IGNORE, SET_IMAGE_P50, SET_IMAGE_P100});
    }

    @Test
    public void testLoadingS_LFS() {
        testStreamedLoading(new int[]{INTERMEDIATE_LOW, INTERMEDIATE_FAILURE, SUCCESS}, new int[]{SET_IMAGE_P20, IGNORE, SET_IMAGE_P100});
    }

    @Test
    public void testLoadingS_GFS() {
        testStreamedLoading(new int[]{INTERMEDIATE_GOOD, INTERMEDIATE_FAILURE, SUCCESS}, new int[]{SET_IMAGE_P50, IGNORE, SET_IMAGE_P100});
    }

    @Test
    public void testLoadingS_FFS() {
        testStreamedLoading(new int[]{INTERMEDIATE_FAILURE, INTERMEDIATE_FAILURE, SUCCESS}, new int[]{IGNORE, IGNORE, SET_IMAGE_P100});
    }
    ...
    private void testLoading(boolean isImmediate, int outcome, int dhInteraction) {
        FakeDraweeController controller = new FakeDraweeController(mDeferredReleaser, mUiThreadExecutor, mDataSourceSupplier, "id2", mCallerContext);
    ...
    private void testStreamedLoading(int numImmediate, int[] outcomes, int[] dhInteraction) {
        FakeDraweeController controller = new FakeDraweeController(mDeferredReleaser, mUiThreadExecutor, mDataSourceSupplier, "id_streamed",
                mCallerContext);
    ...
    public static class FakeDraweeController extends AbstractDraweeController<FakeImage, FakeImageInfo> {
        ...
        public FakeDraweeController(DeferredReleaser deferredReleaser, Executor uiThreadExecutor, Supplier<DataSource<FakeImage>>
                dataSourceSupplier, String id, Object callerContext) {
