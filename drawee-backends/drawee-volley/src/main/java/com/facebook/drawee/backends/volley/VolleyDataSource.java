...
public class VolleyDataSource extends AbstractDataSource<Bitmap> {
    ...
    public VolleyDataSource(final ImageLoader imageLoader, final Uri imageRequest, final boolean bitmapCacheOnly) {
        ...
        mImageContainer = imageLoader.get(uriString, new ImageLoader.ImageListener() {
            @Override
