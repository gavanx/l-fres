...
public class ResizeAndRotateProducer implements Producer<EncodedImage> {
    ...
    private class TransformingConsumer extends DelegatingConsumer<EncodedImage, EncodedImage> {
        ...
        private Map<String, String> getExtraMap(EncodedImage encodedImage, ImageRequest imageRequest, int numerator) {
            ...
            return ImmutableMap.of(ORIGINAL_SIZE_KEY, originalSize, REQUESTED_SIZE_KEY, requestedSize, FRACTION_KEY, fraction, JobScheduler
                    .QUEUE_TIME_KEY, String.valueOf(mJobScheduler.getQueuedTime()));
        }
    }
}
