...
public class LocalContentUriFetchProducer extends LocalFetchProducer {
    ...
    private static boolean isCameraUri(Uri uri) {
        ...
        return uriString.startsWith(MediaStore.Images.Media.EXTERNAL_CONTENT_URI.toString()) || uriString.startsWith(MediaStore.Images.Media
                .INTERNAL_CONTENT_URI.toString());
    }
    ...
    static boolean isThumbnailBigEnough(ResizeOptions resizeOptions, Rect thumbnailDimensions) {
        return resizeOptions.width <= thumbnailDimensions.width() * ACCEPTABLE_REQUESTED_TO_ACTUAL_SIZE_RATIO && resizeOptions.height <=
    ...
    private static int getRotationAngle(String pathname) {
        if (pathname != null) {
            try {
                ...
                return JfifUtil.getAutoRotateAngleFromOrientation(exif.getAttributeInt(ExifInterface.TAG_ORIENTATION, ExifInterface
                        .ORIENTATION_NORMAL));
