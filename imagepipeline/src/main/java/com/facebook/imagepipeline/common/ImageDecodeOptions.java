...
public class ImageDecodeOptions {
    ...
    public String toString() {
        return String.format((Locale) null, "%d-%d-%b-%b-%b-%b", minDecodeIntervalMs, backgroundColor, forceOldAnimationCode, decodePreviewFrame, useLastFrameForPreview, decodeAllFrames);
    }
}
